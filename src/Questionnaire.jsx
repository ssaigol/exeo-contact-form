...
function Questionnaire({
  ...
  const questions = [
    ...
    { key: "question6", question: t("q6"), type: "textarea" },
  ];
    ...
    return (
      <div className="flex flex-col gap-7 px-8 h-56">
        ...
        <div
          ...
          className={`flex flex-col ${currentQuestion === 4 || currentQuestion === 5 ? "pt-0" : "pt-7"} gap-7 justify-start flex-1`}
        >
          <label
            className={
              current.key !== "question6"
