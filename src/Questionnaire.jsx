...
function Questionnaire({
  ...
  return (
    <div className="relative flex flex-col gap-7 px-8 min-h-54">
      {/* Counter & Next/Back */}
      <div className="flex gap-2.5 self-end items-center text-gray-400">
        <button
          onClick={goBackward}
      ...
      <div
        ...
        className={`flex flex-col ${isLast || (pageParam === "citizenship-descent-contactform" && currentQuestion === 5) ? "pt-0" : "pt-7"} gap-7 justify-start flex-1`}
      >
        <label
          className={
            current.required
